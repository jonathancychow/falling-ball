...
def on_planet_select(bike_name):
    if bike_name in planet_data.keys():
        return planet_data[bike_name].mass, planet_data[bike_name].cda, \
                planet_data[bike_name].cda_climbing, \
                planet_data[bike_name].gradient_climbing, \
                planet_data[bike_name].crr
    else:
